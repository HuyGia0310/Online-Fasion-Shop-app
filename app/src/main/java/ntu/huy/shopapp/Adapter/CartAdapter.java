...
import ntu.huy.shopapp.Helper.ChangeNumberItemsListener;
import ntu.huy.shopapp.Helper.ManagmentCart;
import ntu.huy.shopapp.databinding.ViewholderCartBinding;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull CartAdapter.Viewholder holder, int position) {
        holder.binding.title.setText(listItemSelected.get(position).getTitle());
